<template>
  <div>
    <!-- preloader start -->
    <div class="preloader">
      <img src="/dt/images/preloader.gif" alt="preloader">
    </div>
    <!-- preloader end -->
    <!-- navigation -->
    <header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <h2 class="section-title section-title-border-half">好神奇 網頁版交易的優勢</h2>
          </div>
          <div class="col-lg-7">
            <div class="mb-40">
              <p class="text-dark">
                好神奇 可以使您從任何流覽器和任何作業系統，包括Windows，Mac和Linux，開始進行外匯，股票，期貨市場的交易。您可以在網站直接訪問MetaTrader 5桌面平臺提供的豐富功能，這意味著您可以分析報價和交易，而無需下載或安裝任何應用程式。簡單地敲擊幾次，您就可以訪問您的帳戶並開始交易。網路平臺的交易非常安全，傳播的任何資訊都是被安全加密的
          ...
          <div class="col-lg-6 ml-auto">
            <div class="rounded p-sm-5 px-3 py-5 bg-secondary">
              ...
              <p class="text-white mb-40">
                好神奇 網頁版交易 即時穩定的報價與最齊全的商品 為避免報價誤差與延遲，好神奇平台與國外知名報價廠商合作透過精密演算法呈現出與國外同步且精準的報價
無論何時何地，您都可以在好神奇網頁版上查看最精準穩定的報價與最齊全的商品，對全球期貨指數做出理性的交易決策 預測您喜歡金融交易品種的價格動向，通過技術分析，您可以 “窺視未來” 並通過這個優勢來獲得成功！
              </p>
              <div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="d-flex">
              <a class="popup-youtube play-icon mr-4" href="#" onclick="return false;" data-toggle="modal" data-target="#modal">
          ...
          <div class="col-lg-7 col-md-7 align-self-center pl-0">
            <div class="testimonial-slider p-5">
              ...
              <div class="outline-0">
                ...
                <p class="text-dark">我在巨匠 今年21歲 自從用了好神奇交易平台 讓我有了被動收入
                  <br>謝謝好神奇!</p>
              ...
              <div class="outline-0">
                <i class="testimonial-icon ti-quote-left"></i>
                <p class="text-dark">好神奇交易系統 不但安全 可靠 數據非常及時 還能設定停損 是個非常好用的系統
                  <br> 非常推薦給大家使用!
                </p>
              ...
              <div class="outline-0">
                <i class="testimonial-icon ti-quote-left"></i>
                <p class="text-dark">數據分析真的好神奇 非常完整 用了就回不去了 真的很推薦
                  <br> 試一次就知道了
                </p>
    ...
    <section class="cta overlay-primary py-50 text-center text-lg-left" style="background-image: url(/dt/images/background/cta.jpg);">
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-6">
            <h3 class="text-white">輕鬆提升收入 加入好神奇</h3>
          </div>
    ...
    head() {
      return {
        ...
        script: [{
            ...
            src: '/dt/plugins/magnific-popup/jquery.magnific.popup.min.js',
            body: true
        }, {
            src: '/dt/plugins/slick/slick.min.js',
            body: true
        }, {
            src: '/dt/plugins/mixitup/mixitup.min.js',
            body: true
        }, {
            src: '/dt/plugins/syotimer/jquery.syotimer.js',
            body: true
        }, {
            src: '/dt/plugins/aos/aos.js',
            body: true
        }, {
            src: '/dt/js/script.js',
            body: true
        ...
        link: [{
            rel: 'stylesheet',
            href: '/dt/plugins/bootstrap/bootstrap.min.css'
        }, {
            rel: 'stylesheet',
            href: '/dt/plugins/magnific-popup/magnific-popup.css'
        }, {
            rel: 'stylesheet',
            href: '/dt/plugins/slick/slick.css'
        }, {
            rel: 'stylesheet',
            href: '/dt/plugins/slick/slick-theme.css'
        }, {
            rel: 'stylesheet',
            href: '/dt/plugins/themify-icons/themify-icons.css'
        }, {
            rel: 'stylesheet',
            href: '/dt/plugins/animate/animate.css'
        }, {
            rel: 'stylesheet',
            href: '/dt/plugins/aos/aos.css'
        }, {
            rel: 'stylesheet',
