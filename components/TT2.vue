          ...
          <div class="sticky-header">
              <div class="auto-container clearfix">
                  ...
                  <div class="logo pull-left">
                      <a href="index.html" title=""><img src="/tt2/images/sticky-logo.png" alt="" title=""></a>
                  </div>
                  <!--Right Col-->
              ...
              <div class="row align-items-center">
                  <div class="col-lg-6">
                      <div class="image-wrapper">
                          <div class="image-one">
                              <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/image-2.jpg" alt="">
                          </div>
                          <div class="image-two wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                              <div class="caption">F.</div>
                              <div class="image-outer"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/image-3.jpg" alt=""></div>
                          </div>
                      </div>
                  </div>
                  <div class="col-lg-6">
                      <div class="content-box">
                          <div class="sec-title">
                              ...
                              <div class="text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                          ...
                          <div class="row">
                              <div class="info-column col-md-6">
                                  <div class="icon-box">
                                      <div class="icon"><img src="/tt2/images/icons/icon-1.png" alt=""></div>
                                      <h5>Phone Number</h5>
                                      <h2>+897 6765 754</h2>
                                  </div>
                              </div>
                              <div class="info-column col-md-6">
                                  <div class="icon-box">
                                      <div class="icon"><img src="/tt2/images/icons/icon-2.png" alt=""></div>
                                      <h5>Email Address</h5>
                      ...
                      <div class="col-lg-3 col-md-6 gallery-block-one all">
                          <div class="inner-box">
                              ...
                              <div class="caption-title">
                                  ...
                                  <div class="view-project"><a data-fancybox="example gallery" href="/tt2/images/gallery/gallery-10.jpg" class="zoom-btn"><span>+</span></a></div>
                              </div>
                          </div>
                      </div>
                      <!-- Gallery Block One -->
                      <div class="col-lg-3 col-md-6 gallery-block-one all category-3 category-4">
                          <div class="inner-box">
                              ...
                              <div class="caption-title">
                                  <h5>Finance</h5>
                                  <h3><a href="#">Miranda Hilix Bar</a></h3>
                                  <div class="view-project"><a data-fancybox="example gallery" href="/tt2/images/gallery/gallery-11.jpg" class="zoom-btn"><span>+</span></a></div>
                              </div>
                          </div>
                      </div>
                      <!-- Gallery Block One -->
                      <div class="col-lg-3 col-md-6 gallery-block-one all category-1 category-4">
                          <div class="inner-box">
                              ...
                              <div class="caption-title">
                                  <h5>Finance</h5>
                                  <h3><a href="#">Miranda Hilix Bar</a></h3>
                                  <div class="view-project"><a data-fancybox="example gallery" href="/tt2/images/gallery/gallery-12.jpg" class="zoom-btn"><span>+</span></a></div>
                              </div>
                          </div>
                      </div>
                      <!-- Gallery Block One -->
                      <div class="col-lg-3 col-md-6 gallery-block-one all category-3 category-2">
                          <div class="inner-box">
                              ...
                              <div class="caption-title">
                                  <h5>Finance</h5>
                                  <h3><a href="#">Miranda Hilix Bar</a></h3>
                                  <div class="view-project"><a data-fancybox="example gallery" href="/tt2/images/gallery/gallery-13.jpg" class="zoom-btn"><span>+</span></a></div>
                              </div>
                          </div>
                      </div>
                      <!-- Gallery Block One -->
                      <div class="col-lg-3 col-md-6 gallery-block-one all category-3 category-2 category-5">
                          <div class="inner-box">
                              ...
                              <div class="caption-title">
                                  <h5>Finance</h5>
                                  <h3><a href="#">Miranda Hilix Bar</a></h3>
                                  <div class="view-project"><a data-fancybox="example gallery" href="/tt2/images/gallery/gallery-14.jpg" class="zoom-btn"><span>+</span></a></div>
                              </div>
                          </div>
                      </div>
                      <!-- Gallery Block One -->
                      <div class="col-lg-3 col-md-6 gallery-block-one all category-1 category-4">
                          <div class="inner-box">
                              ...
                              <div class="caption-title">
                                  <h5>Finance</h5>
                                  <h3><a href="#">Miranda Hilix Bar</a></h3>
                                  <div class="view-project"><a data-fancybox="example gallery" href="/tt2/images/gallery/gallery-15.jpg" class="zoom-btn"><span>+</span></a></div>
                              </div>
                          </div>
                      </div>
                      <!-- Gallery Block One -->
                      <div class="col-lg-3 col-md-6 gallery-block-one all category-3 category-2">
                          <div class="inner-box">
                              ...
                              <div class="caption-title">
                                  <h5>Finance</h5>
                                  <h3><a href="#">Miranda Hilix Bar</a></h3>
                                  <div class="view-project"><a data-fancybox="example gallery" href="/tt2/images/gallery/gallery-16.jpg" class="zoom-btn"><span>+</span></a></div>
                              </div>
                          </div>
                      </div>
                      <!-- Gallery Block One -->
                      <div class="col-lg-3 col-md-6 gallery-block-one all category-3 category-2 category-5">
                          <div class="inner-box">
                              ...
                              <div class="caption-title">
                                  <h5>Finance</h5>
                                  <h3><a href="#">Miranda Hilix Bar</a></h3>
                                  <div class="view-project"><a data-fancybox="example gallery" href="/tt2/images/gallery/gallery-17.jpg" class="zoom-btn"><span>+</span></a></div>
                              </div>
                          </div>
                      </div>
                      <!-- End block -->
      ...
      <section class="why-chooseus-section">
          <div class="auto-container">
              <div class="row align-items-center">
                      ...
                      <div class="content-box">
                          ...
                          <div class="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                              <div class="tab-pane fadeInUp animated active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                                  <div class="clearfix">
                                      <div class="image"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/image-4.jpg" alt=""></div>
                                      <div class="text">
                  ...
                  <div class="col-lg-6">
                      <div class="image-wrapper">
                          <div class="image-one"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/image-6.jpg" alt=""></div>
                          <div class="image-two"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/image-5.jpg" alt=""></div>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="auto-container">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4 team-block-one wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                      <div class="inner-box">
                          <div class="image"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/team-1.jpg" alt=""></div>
                          <div class="content">
                              <div class="designation">Founder</div>
                  ...
                  <div class="col-lg-4 team-block-one wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                      <div class="inner-box">
                          <div class="image"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/team-2.jpg" alt=""></div>
                          <div class="content">
                  ...
                  <div class="col-lg-4 team-block-one wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                      <div class="inner-box">
                          <div class="image"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/team-3.jpg" alt=""></div>
                          <div class="content">
          ...
          <div class="auto-container">
              ...
              <div class="row">
                  ...
                  <div class="news-block-one col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                      <div class="inner-box">
                          <div class="image"><a href="#"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/news-1.jpg" alt=""></a></div>
                  ...
                  <div class="news-block-one col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                      <div class="inner-box">
                          <div class="image"><a href="#"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/news-2.jpg" alt=""></a></div>
                          <div class="lower-content">
                              <div class="category">Business</div>
                              <ul class="post-meta">
                  ...
                  <div class="news-block-one col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                      <div class="inner-box">
                          <div class="image"><a href="#"><img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/resource/news-3.jpg" alt=""></a></div>
                          <div class="lower-content">
                              <div class="category">Business</div>
                              <ul class="post-meta">
      ...
      <section class="award-section pt-0">
          ...
          <div class="auto-container">
              ...
              <div class="award-image">
                  <div class="row align-items-center">
                      <div class="col-lg-4">
                          <div class="image wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms"><img src="/tt2/images/resource/award-1.png" alt=""></div>
                          <div class="image wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms"><img src="/tt2/images/resource/award-2.png" alt=""></div>
                      </div>
                      <div class="col-lg-4 order-lg-2">
                          <div class="image wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms"><img src="/tt2/images/resource/award-3.png" alt=""></div>
                          <div class="image wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms"><img src="/tt2/images/resource/award-4.png" alt=""></div>
                      </div>
                          ...
                          <div class="footer-widget logo-widget">
                              <div class="widget-content">
                                  <div class="footer-logo">
                                      <a href="index.html"><img class="lazy-image" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/footer-logo.png" alt="" /></a>
                                  </div>
                      ...
                      <div class="column col-lg-4">
                          <div class="footer-widget instagram-widget">
                              ...
                              <div class="inner-box">
                                  <div class="wrapper-box">
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-1.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-1.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-2.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-2.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-3.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-3.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-4.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-4.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-5.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-5.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-6.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-6.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-7.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-7.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-8.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-8.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                      <div class="image">
                                          <img class="lazy-image owl-lazy" src="/tt2/images/resource/image-spacer-for-validation.png" data-src="/tt2/images/gallery/gallery-9.jpg" alt="">
                                          <div class="overlay-link"><a href="/tt2/images/gallery/gallery-9.jpg" class="lightbox-image" data-fancybox="gallery"><span class="fa fa-plus"></span></a></div>
                                      </div>
                                  </div>
                                  <!-- /.gallery-wrapper -->
                              </div>
  ...
  head() {
    return {
      ...
      script: [
        ...
        { src: '/tt2/js/popper.min.js', body: true },
        { src: '/tt2/js/bootstrap.min.js', body: true },
        { src: '/tt2/js/bootstrap-select.min.js', body: true },
        { src: '/tt2/js/jquery.fancybox.js', body: true },
        { src: '/tt2/js/isotope.js', body: true },
        { src: '/tt2/js/owl.js', body: true },
        { src: '/tt2/js/appear.js', body: true },
        { src: '/tt2/js/wow.js', body: true },
        { src: '/tt2/js/lazyload.js', body: true },
        { src: '/tt2/js/scrollbar.js', body: true },
        { src: '/tt2/js/TweenMax.min.js', body: true },
        { src: '/tt2/js/script.js', body: true },
      ],
      link: [
        { rel: 'stylesheet', href: '/tt2/css/bootstrap.css' },
        { rel: 'stylesheet', href: '/tt2/css/style.css' },
        { rel: 'stylesheet', href: '/tt2/css/responsive.css' },
        { rel: 'stylesheet', href: '/tt2/css/color.css' },
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900&display=swap" rel="stylesheet' },
      ]
    }
  },
  data () {
